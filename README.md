...
Custom OS image built on top of [Project Bluefin](https://projectbluefin.io).
...
Important: This repository uses the name **`penguix`**. If you fork or rebrand, update that name consistently in these 7 files:
